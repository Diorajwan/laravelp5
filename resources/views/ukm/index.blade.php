                ...
                <tbody>
                  ...
                  @foreach ($ukm as $data)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('ukm.show', $data->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-eye"></i></a>
                        <a href="{{ route('ukm.edit', $data->id) }}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                        <form action="{{ route('ukm.destroy', $data->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                          @csrf
                          @method('DELETE')
